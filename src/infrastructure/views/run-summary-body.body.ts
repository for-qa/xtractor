...
export function RunSummaryBody(props: RunSummaryBodyProps) {
  ...
  <main class="main-container">
    <div class="report-card-box">
      <div class="page-body">
        <div class="tabs">
          <button class="tab-btn active" onclick="switchTab('dashboard', this)">Analytics Dashboard</button>
          <button class="tab-btn" onclick="switchTab('history', this)">Operation History</button>
        </div>
