import { DashboardBody } from "./dashboard-body.body.js";
  ...
  static getStyles() {
    return `
      ...
      button.reset-case {
        ...
        text-overflow: ellipsis; display: inline-flex; align-items: center; justify-content: center; gap: 8px;
      }
      ...
      .schedule-label {
        ...
        padding: 0.25rem 0.65rem; width: fit-content; text-transform: uppercase;
        letter-spacing: 0.06em; margin-bottom: 0.2rem; border-radius: 4px;
      }
