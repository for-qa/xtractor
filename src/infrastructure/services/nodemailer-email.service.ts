              ...
              <tbody>
                ...
                <tr>
                  <td align="center" style="padding:10px 30px 35px 30px;font-size:12px;color:#888;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                    ...
                    This is an automated message from Xtractor.<br>
                    © ${currentYear} Xtractor. Open-source portfolio project.
                  </td>
                </tr>
              </tbody>
            </table>
...
<body>
  <div class="container">
    <div class="header">
      <img src="cid:logo" alt="Xtractor" style="height: 28px; width: auto; margin-bottom: 12px; display: block;">
    ...
    <div class="footer">
      This is an automated notification from Xtractor.
      <br>&copy; ${new Date().getFullYear()} Xtractor. Open-source portfolio project.
    </div>
  </div>
</body>
</html>`;
