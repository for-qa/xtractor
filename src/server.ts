...
import { XtractorService } from "./infrastructure/services/xtractor.service.js";
...
const _rawExtractionRecordPath =
  appConfig.run.databasePath || join(ROOT, "output", "Xtractor.db");
...
const extractionService = new XtractorService(appConfig);
...
const httpServer = createServer(async (req, res) => {
  ...
  console.log(`Xtractor app: http://localhost:${PORT}/`);
